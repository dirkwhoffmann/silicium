...
//
// List model backing SiAmMemoryPanel's hex/ASCII dump table. Port of
// SiC64MemDumpModel -- no vc64/vAmiga-specific types anywhere in here, so
// this needed no adaptation beyond the class name. Kept as a single,
...
class SiAmMemDumpModel : public QAbstractListModel {
  ...
  public:
    ...
    explicit SiAmMemDumpModel(QObject *parent = nullptr);
