...
// SiAmCPUController's activeChanged hook).
SiBox {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        Value { Layout.fillWidth: true; Layout.preferredWidth: root.addrColW; text: traceDelegate.addr }
                        Rectangle { Layout.preferredWidth: 1; Layout.fillHeight: true; color: Palette.surfaceBorder }
                        Value { Layout.fillWidth: true; Layout.preferredWidth: root.flagsColW; text: traceDelegate.flags }
                        Rectangle { Layout.preferredWidth: 1; Layout.fillHeight: true; color: Palette.surfaceBorder }
                        Value { Layout.fillWidth: true; Layout.preferredWidth: root.instrColW; text: traceDelegate.instr }
                    }
                }
            }
        }
