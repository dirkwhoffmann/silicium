...
SiC64TraceModel::SiC64TraceModel(QObject *parent)
...
int
SiC64TraceModel::rowCount(const QModelIndex &parent) const
{
    return parent.isValid() ? 0 : m_rows.size();
}

QVariant
SiC64TraceModel::data(const QModelIndex &index, int role) const
{
...
SiC64TraceModel::roleNames() const
{
    return {
...
void
SiC64TraceModel::setRows(const QVector<Row> &rows)
{
