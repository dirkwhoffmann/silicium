...
//
// List model backing SiC64EventsPanel's event table. Kept as a single,
...
class SiC64EventTableModel : public QAbstractListModel {
  ...
  public:
    ...
    explicit SiC64EventTableModel(QObject *parent = nullptr);
