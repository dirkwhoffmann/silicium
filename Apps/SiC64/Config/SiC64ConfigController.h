...
class SiC64ConfigController : public Controller {
  ...
  private:
    ...
    QString getBasicRomSubtitle() const { return QString::fromUtf8(basicRom.model); }
    ...
    QString getKernalRomSubtitle() const { return QString::fromUtf8(kernalRom.model); }
    ...
    QString getCharRomSubtitle() const { return QString::fromUtf8(charRom.model); }
    ...
    QString getVC1541RomSubtitle() const { return QString::fromUtf8(vc1541Rom.model); }
