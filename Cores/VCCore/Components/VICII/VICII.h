...
private:
     ...
     * drawn by the GUI. The xrayTex buffer contain the textures generated by
...
private:
    ...
    void resetXrayTexture(isize nr);
    void resetXrayTextures();
...
private:
    ...
    // [[deprecated]] u32 *oldGetXrayTexture() const;
