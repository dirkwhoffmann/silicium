...
const RomTraits *
RomManager::findByFnv(u64 fnv)
{
    // Refuse the zero key -- it would match every Amiga entry
    if (fnv == 0) return nullptr;
...
const RomTraits *
RomManager::findByCrc(u32 crc)
{
    // Refuse the zero key -- it would match every C64 entry
